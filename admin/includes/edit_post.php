...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="post_category_id" class="custom-select">
        ...
        <div class="custom-file" style="margin:12px 0 0 0">
            <input type="file" class="custom-file-input" name="post_image">
            <label class="custom-file-label" for="customFile">Choose Image</label>
        </div>
        <img class="img-fluid" style="margin-bottom:15px; margin-top:4px;" src="../images/<?php echo $post_image; ?>" alt="" width="100">
