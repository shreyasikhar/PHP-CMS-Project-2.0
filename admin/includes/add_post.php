...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="post_category" class="form-control custom-select">
            <?php  
        ...
        <div class="form-group">
            ...
            <select name='post_status' class="form-control custom-select">
        ...
        <div class="custom-file" style="margin:12px 0 15px 0">
