...
?>
<div class="container">
    <h1>View All Posts</h1><hr/>
    <form method="post" action="">
    <div class="table-responsive">
        <table class="table table-bordered table-hover" style="background-color:#fff;">
            <div class="row" style="margin:5px">
                <div id="bulkOptionsContainer" style='padding:0px' class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <select class="form-control custom-select" name="bulk_options">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-top:2px;">
            ...
            <?php        
                    ...
                    echo "<td><img class='img-fluid' src='../images/{$post_image}' width='100' alt='image'></td>";
