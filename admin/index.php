                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <a href="posts.php" style="text-decoration:none">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $post_count = count_records(get_all_user_posts()); ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <a href="comments.php" style="text-decoration:none">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $comment_count = count_records(get_all_posts_user_comments()); ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <a href="categories.php" style="text-decoration:none">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $category_count = count_records(get_all_user_categories()); ?></div>
                    </div>
                    <div class="col-auto">
